...
//            int soluong = Integer.valueOf(request.getParameter("soluong"));
            ...
            String imgFolderPath = "src" + File.separator + "main" + File.separator + "webapp" + File.separator + "assets" + File.separator + "img" + File.separator + "products";
            String appPath = "D:" + File.separator + "SPRING_24" + File.separator + "SWP" + File.separator + "Du_An" + File.separator + "SWP";
        ...
        if (request.getParameter("btnEdit") != null) {
            ...
            String imgFolderPath = "src" + File.separator + "main" + File.separator + "webapp" + File.separator + "assets" + File.separator + "img" + File.separator + "products";
            String appPath = "D:" + File.separator + "SPRING_24" + File.separator + "SWP" + File.separator + "Project_C" + File.separator + "FruitShop";
            String uploadPath = appPath + File.separator + imgFolderPath;
